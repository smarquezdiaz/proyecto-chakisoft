...
test.describe('CRUD de Listas Trello', () => {
  ...
  test('AE-UI-TC-01: Verificar que se pueda crear lista @Smoke  @Regression ', async ({ page, listPage }) => {
  ...
  test('AE-UI-TC-02: Verificar la funcionalidad de renombrar lista @Smoke  @Regression', async ({ page, listPage }) => {
    allure.owner('Andres Adrian Estrada Uzeda');
  ...
  test('AE-UI-TC-03: Verificar la funcionalidad  mover lista por posicion @Smoke  @Regression ', async ({ page, listPage }) => {
    allure.owner('Andres Adrian Estrada Uzeda');
    allure.severity('normal');
  ...
  test('AE-UI-TC-04: Verificar la funcionalidad de copiar una lista @Smoke  @Regression ', async ({ page, listPage }) => {
    allure.owner('Andres Adrian Estrada Uzeda');
    allure.severity('normal');
  ...
  test('AE-UI-TC-05: Verificar la funcionalidad de archivar una lista @Smoke  @Regression', async ({ page, listPage }) => {
    allure.owner('Andres Adrian Estrada Uzeda');
    allure.severity('critical');
  ...
  test('AE-UI-TC-06: Verificar la funcionalidad de eliminar una lista archivada @Smoke  @Regression', async ({ page, listPage }) => {
    allure.owner('Andres Adrian Estrada Uzeda');
    allure.severity('critical');
